...
Процедура ОбработатьДокумент(ХешСумма, РучнойЗапуск = Ложь) Экспорт
	...
	Иначе
		...
		Если ДанныеФайла <> Неопределено Тогда
			...
			ПС_ИндексацияФайловВызовСервера.ОбработатьДокумент(ХешСумма, АдресХранилища, РучнойЗапуск);
