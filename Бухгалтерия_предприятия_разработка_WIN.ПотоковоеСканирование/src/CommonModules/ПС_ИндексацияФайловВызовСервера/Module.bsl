...
Процедура НайтиСвязиПоКлючевымРеквизитам(ЗаписьРегистра, ЗагрузкаНовогоДокумента = Ложь)
	...
	ОпределитьОрганизацию(ЗаписьРегистра, СокрЛП(СтруктураКлючевыхРеквизитов[ИмяПоля_ИД_Поставщика]), ТочностьСтрогогоПоиска, ЭтоИсходящийДокумент, Истина);
	ОпределитьОрганизацию(ЗаписьРегистра, СокрЛП(СтруктураКлючевыхРеквизитов[ИмяПоля_ИД_Клиента]), ТочностьСтрогогоПоиска, ЭтоИсходящийДокумент, Ложь);

	ОпределитьКонтрагента(ЗаписьРегистра, СокрЛП(СтруктураКлючевыхРеквизитов[ИмяПоля_ИД_Клиента]), ТочностьСтрогогоПоиска, ЭтоИсходящийДокумент, Истина);
	ОпределитьКонтрагента(ЗаписьРегистра, СокрЛП(СтруктураКлючевыхРеквизитов[ИмяПоля_ИД_Поставщика]), ТочностьСтрогогоПоиска, ЭтоИсходящийДокумент, Ложь);
...
Процедура ОпределитьОрганизацию(ЗаписьРегистра, ИНН, ТочностьСтрогогоПоиска, ФлагИсходящийДокумент, ПереданИННПоставщика)
...
Процедура ОпределитьКонтрагента(ЗаписьРегистра, ИНН, ТочностьСтрогогоПоиска, ФлагИсходящийДокумент, ПереданИННКлиента)
