...
Процедура ОбработатьДокумент(ХешСумма, РучнойЗапуск = Ложь, ИД = Неопределено) Экспорт
	...
	Иначе
		...
		Если ДанныеФайла <> Неопределено Тогда
			...
			ПС_ИндексацияФайловВызовСервера.ОбработатьДокумент(ХешСумма, АдресХранилища, РучнойЗапуск, ИД);
